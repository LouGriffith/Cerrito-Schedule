...
define( 'CERRITO_SCHEDULE_VERSION', '6.16.0' );
...
// -- Admin --------------------------------------------------------------------
if ( is_admin() ) {
    require_once CERRITO_SCHEDULE_DIR . 'includes/cerrito-events-admin.php';
}
...
require_once CERRITO_SCHEDULE_DIR . 'includes/shortcode-locations.php';
require_once CERRITO_SCHEDULE_DIR . 'includes/shortcode-game-type-schedule.php';
